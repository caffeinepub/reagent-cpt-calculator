...
export class Backend implements backendInterface {
    ...
    async listSessions(): Promise<Array<[string, Session]>> {
        if (this.processError) {
            try {
    ...
    async saveSession(arg0: string, arg1: string, arg2: number, arg3: Array<[string, number, number]>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveSession(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
